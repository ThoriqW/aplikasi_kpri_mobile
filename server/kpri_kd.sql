...
INSERT INTO `member_profiles` (`id`, `user_member_id`, `full_name`, `position`, `work_unit_id`, `address`, `photo_url`, `join_date`, `status`, `gender`, `birth_date`, `created_at`, `updated_at`) VALUES
(1, 1, 'Moh Dwi Ramdhani', 'Tank', 1, 'veteran', 'https///', '2024-01-15', 'active', 'male', '1999-01-15', '2024-06-25 06:40:04', '2024-06-25 06:40:04');
...
CREATE TABLE `notifications` (
  `id` int NOT NULL,
  `user_member_id` int NOT NULL,
  `type` enum('koperasi','anggota') NOT NULL,
  `notification_type` enum('warning','success','danger','info') NOT NULL,
...
INSERT INTO `notifications` (`id`, `user_member_id`, `type`, `notification_type`, `title`, `message`, `status`, `created_at`, `updated_at`) VALUES
(1, 1, 'koperasi', 'warning', 'sfa', 'saddas', 'read', '2024-06-21 23:33:16', '2024-06-21 23:33:58');
...
--
ALTER TABLE `notifications`
  ADD CONSTRAINT `notifications_ibfk_1` FOREIGN KEY (`user_member_id`) REFERENCES `user_members` (`id`);
COMMIT;
